export function getForgotPasswordEmailHtml(url: string) {
    return `
      <!DOCTYPE html>
      <html lang="en">
      <head>
        ...
        <style>
          ...
          .button { display: inline-block; background: #28a745; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 5px; margin-top: 20px; }
      ...
      <body>
        <div class="container">
          <div class="header"><h1>Zahid Pharmacy</h1></div>
          <div class="content">
            <p>Hi,</p>
